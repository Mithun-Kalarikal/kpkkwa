...
<form class="form-horizontal"  id="form_customer" action="{{ route('captureStore') }}"  method="POST"   enctype="multipart/form-data" >
    @csrf
      ...
      <div class="col-lg-12 col-md-12 col-12">
        <div class="table-responsive">
            ...
            <tbody>
              <tr>
                ...
                <td>    
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                      <select id="inputState" name="outletAvailable[]" class="form-select">
                       <option >Yes</option>
              ...
              <td>
                <div class="row g-3">
                  <div class="col-lg-12 col-md-12 col-12">
                    <input type="text" class="form-control" id="inputType" placeholder="Type Here" name="price[]">
                  </div>
                </div>
              </td>
         ...
         <td>
          <div class="row g-3">
            <div class="col-lg-12 col-md-12 col-12">
              <input type="text" name="price[]" class="form-control" id="inputType" placeholder="Type Here">
            </div>
          </div>
        </td>
...
<tr>
  ...
  <td>Glenfiddich Grande Couronne<br>(Whiskey)</td>
   <input type="hidden" name="category[]" value="Whiskey">
                <input type="hidden" name="description[]" value="Glenfiddich Grande Couronne">
  <td>    
    <div class="row">
      <div class="col-lg-12 col-md-12 col-12">
        <select id="inputState" name="outletAvailable[]" class="form-select">
  ...
  <div class="container cust-border p-lg-0">
    <div class="row ">
      <div class="col-lg-10 col-md-9 col-9">
        <p>If Hendricks Original listed, IS bar providing perfect serve for the brand-are they serving it with a cucumber ?</p>
      </div>
...
$(document).ready(function(){
 ...
 $("#area").change(function(){
  ...
  $.ajax({
      ...
      method: 'POST',
      data:{"_token": $('#csrftoken').val(),area:area},
 ...
 $("#account").change(function(){
  ...
  $.ajax({
      ...
      method: 'POST',
      data:{"_token": $('#csrftoken').val(),account:account},
      success:function(response)
      {   
         var value=JSON.parse(response);
         var ss = [];
