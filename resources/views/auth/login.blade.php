...
<div class="login-wrpr" style="display: block;"> 
    ...
    rgba(255, 0, 0, 0.45)),url('{{ asset("resources/images/bg.jpg") }}');height: 200px;">
        
    </div>
        <div class="text-left" >
           
                  <img src="{{ asset('resources/images/logo.png') }}" style="width: 185px;margin: -25px 0 0 17px;" alt="logo">
